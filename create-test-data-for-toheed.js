...
async function createTestDataForToheed() {
  console.log('🚀 Creating test data for toheed@yahoo.com...\n');
  
  if (TOKEN === 'YOUR_JWT_TOKEN_HERE') {
    console.log('⚠️  IMPORTANT: You need to get your JWT token first!');
    console.log('');
    ...
    console.log('7. Replace "YOUR_JWT_TOKEN_HERE" in this script');
    console.log('');
  ...
  try {
    ...
    console.log('📝 Creating test URLs for toheed@yahoo.com...');
...
// Instructions
console.log('🔧 Test Data Creation for toheed@yahoo.com');
console.log('==========================================');
console.log('');
console.log('This script will:');
console.log('1. Create test URLs for your account');
console.log('2. Simulate clicks from different countries');
console.log('3. Generate analytics data for testing');
console.log('');
console.log('📋 Before running:');
console.log('1. Make sure you\'re logged in as toheed@yahoo.com');
